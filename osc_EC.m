...
% This function calculates solutions using the Euler-Cromer method and
...
[u,v,t,e] = osc_EC_func(X_0, omega, dt, T);
figure; plot(t,u,'b-', t, X_0*cos(omega*t), 'r--');
title('Numerical vs exact');
figure; plot(t,e,'b-');
title('Total Energy with the Euler Cromer Method');

function [u,v,t,e] = osc_EC_func(X_0, omega, dt, T)
    N_t=floor(T/dt);
